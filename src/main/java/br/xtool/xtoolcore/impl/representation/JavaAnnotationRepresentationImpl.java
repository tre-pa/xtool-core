 ...
 *
 */
public class JavaAnnotationRepresentationImpl<T extends JavaSource<T>> implements JavaAnnotationRepresentation<T> {

	private AnnotationSource<T> annotation;

	public JavaAnnotationRepresentationImpl(AnnotationSource<T> annotation) {
		super();

...
import br.xtool.xtoolcore.representation.plantuml.PlantClassFieldPropertyRepresentation;
import br.xtool.xtoolcore.representation.plantuml.PlantClassFieldRepresentation;
import br.xtool.xtoolcore.representation.plantuml.PlantEnumRepresentation;
...
public class PlantClassFieldRepresentationImpl implements PlantClassFieldRepresentation {
	...
	@Override
	public boolean isId() {
		return this.getProperty(PlantClassFieldPropertyRepresentation.FieldPropertyType.ID).isPresent();
	}
	...
	@Override
	public Optional<PlantClassFieldPropertyRepresentation> getProperty(PlantClassFieldPropertyRepresentation.FieldPropertyType type) {
		// @formatter:off

...
import br.xtool.xtoolcore.representation.springboot.JavaClassRepresentation;
import br.xtool.xtoolcore.representation.springboot.JavaFieldRepresentation;
import br.xtool.xtoolcore.representation.springboot.JavaRelationshipRepresentation;
...
public class JavaRelationshipRepresentationImpl implements JavaRelationshipRepresentation {
	...
	public Optional<JavaFieldRepresentation> getTargetField() {
		Predicate<JavaFieldRepresentation> listPredicate = javaField -> javaField.isCollectionField()

...
import br.xtool.xtoolcore.representation.plantuml.*;
...
public class PlantClassRepresentationImpl implements PlantClassRepresentation {
    ...
    @Override
    public org.jboss.forge.roaster.model.Annotation<JavaClassSource> getAnnotation(Class<? extends Annotation> aClass) {
        return null;
    }

    @Override
    public org.jboss.forge.roaster.model.Annotation<JavaClassSource> getAnnotation(String s) {
        return null;
    }

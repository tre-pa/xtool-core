...
import br.xtool.xtoolcore.representation.springboot.JavaEnumRepresentation;
...
public class JavaEnumRepresentationImpl implements JavaEnumRepresentation {

    private SpringBootProjectRepresentation project;

    private JavaEnumSource javaEnumSource;

    public JavaEnumRepresentationImpl(SpringBootProjectRepresentation project, JavaEnumSource javaEnumSource) {
        super();
    ...
    public JavaPackageRepresentation getJavaPackage() {
        return JavaPackageRepresentationImpl.of(this.javaEnumSource.getPackage());
    }

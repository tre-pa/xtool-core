...
import br.xtool.xtoolcore.impl.representation.PomDependencyRepresentationImpl;
...
public interface PomRepresentation {
	 ...
	 * @return
	 */
	PomRepresentation addDependency(String groupId, String artifactId, PomDependencyRepresentationImpl.ScopeType scopeType);
